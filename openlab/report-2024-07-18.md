...
J'ai passé pas mal de temps à implémenter le RAN. Naïvement je pensais que cela aller être très simple, puis j'ai rencontrer des difficultés lié à Pytorch dans l'implémentation de la Truncated BackPropagation Through Time.
...
![RAN](./picture-2024-07-18/ran.png)

Ici, au lieu d'avoir une mémoire par unité, nous avons une mémoire globale, inclus dans l'état du RAN. Ainsi, à chaque pas de temps, nous mettons à jour cette mémoire globale à partir des entrées et de l'état précédent. 
...
Dépôt github tèrs récent (depuis 01/07/24) : [GraphRag](https://github.com/microsoft/graphrag)
